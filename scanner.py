...
QUOTA_INTRADAY        = 300     # < 24h  (crypto, sport du jour, événements immédiats)
QUOTA_TRES_COURT      = 1500    # 1-7j
QUOTA_COURT           = 400     # 7-14j
...
def recuperer_evenements():
    ...
    for offset in range(0, 4000, limite_par_page):
        params = {
            "active"    : "true",
            "closed"    : "false",
